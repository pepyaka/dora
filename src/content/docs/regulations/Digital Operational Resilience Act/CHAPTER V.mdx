...
### Key principles for a sound management of ICT third-party risk {#section-i}
...
### Oversight Framework of critical ICT third-party service providers {#section-ii}
