...
banner:
  content: CHAPTER VI
sidebar:
  label: CHAPTER VI - Information-sharing arrangements
  order: 107
---
import "/src/styles/regulations.css";

### <span class="article-number">Article 45</span>  <span class="article-name">Information-sharing arrangements on cyber threat information and intelligence</span> 
