...
## ICT Security policies, procedures, protocols, and tools {#chapter-i}

### {#section-1}

#### General elements of ICT security policies, procedures, protocols, and tools {#article-2}
...
### ICT asset management {#section-3}

#### ICT asset management policy {#article-4}
...
#### ICT asset management procedure {#article-5}
...
### Encryption and cryptography {#section-4}

#### Encryption and cryptographic controls {#article-6}
...
### ICT operations security {#section-5}

#### Policies and procedures for ICT operations {#article-8}
...
#### Capacity and performance management {#article-9}
...
#### Vulnerability and patch management {#article-10}
...
#### Data and system security {#article-11}
...
#### Network security management {#article-13}
...
#### Securing information in transit {#article-14}
...
### ICT project and change management {#section-7}

#### ICT project management {#article-15}
...
#### ICT systems acquisition, development, and maintenance {#article-16}
...
#### ICT change management {#article-17}
...
#### Physical and environmental security {#article-18}
...
## Human resources policy and access control {#chapter-ii}

#### Human resources policy {#article-19}
...
#### Identity management {#article-20}
...
## ICT-related incident detection and response {#chapter-iii}

#### ICT-related incident management policy {#article-22}
...
#### Anomalous activities detection and criteria for ICT-related incidents detection and response {#article-23}
...
## ICT business continuity management {#chapter-iv}

#### Components of the ICT business continuity policy {#article-24}
...
#### Testing of the ICT business continuity plans {#article-25}
...
#### ICT response and recovery plans {#article-26}
...
## Report on the ICT risk management framework review {#chapter-v}

#### Format and content of the report on the review of the ICT risk management framework {#article-27}
