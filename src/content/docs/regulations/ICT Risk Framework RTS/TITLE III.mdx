...
## Simplified ICT risk management framework {#chapter-i}

#### Governance and organisation {#article-28}
...
#### Information security policy and measures {#article-29}
...
#### Classification of information assets and ICT assets {#article-30}
...
#### ICT risk management {#article-31}
...
#### Physical and environmental security {#article-32}
...
## Further elements of systems, protocols, and tools to minimise the impact of ICT risk {#chapter-ii}

#### Access Control {#article-33}
...
#### ICT operations security {#article-34}
...
#### Data, system and network security {#article-35}
...
#### ICT security testing {#article-36}
...
#### ICT systems acquisition, development, and maintenance {#article-37}
...
#### ICT project and change management {#article-38}
...
## ICT business continuity management {#chapter-iii}

#### Components of the ICT business continuity plan {#article-39}
...
#### Testing of business continuity plans {#article-40}
...
## Report on the review of the simplified ICT risk management framework {#chapter-iv}

#### Format and content of the report on the review of the simplified ICT risk management framework {#article-41}
